...
class _HotelDashboardState extends State<HotelDashboard> {
  ...
  Future getdata() async{
    ...
    setState(() {
      widget.name = decodeData['hotel_name'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: UserDashboardHotel(),
      bottomNavigationBar: const HotelBottomNavigation(),
    );
  }
}
