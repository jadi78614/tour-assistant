...
class HotelDashboardDrawer extends StatefulWidget {
  String stringid;
  String name;
  String password;
  String address;
  ...
  @override
  State<HotelDashboardDrawer> createState() => _HotelDashboardDrawerState();
}

class _HotelDashboardDrawerState extends State<HotelDashboardDrawer> {
