...
class DriverDashboardDrawer extends StatefulWidget {
  String stringid;
  String name;
  String password;
  String address;
  ...
  @override
  State<DriverDashboardDrawer> createState() => _DriverDashboardDrawerState();
}

class _DriverDashboardDrawerState extends State<DriverDashboardDrawer> {
