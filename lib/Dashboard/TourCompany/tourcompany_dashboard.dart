...
class TourCompanyDashboard extends StatefulWidget {
  dynamic stringid;
  dynamic name;
  dynamic status;
  dynamic email;
  ...
  @override
  State<TourCompanyDashboard> createState() => _TourCompanyDashboardState();
}

class _TourCompanyDashboardState extends State<TourCompanyDashboard> {
  ...
  Future getdata() async{
    ...
    setState(() {
      widget.name = decodeData['biz_name'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //
      // ),
      drawer: TourCompanyDashboardDrawer(
      ...
      body: UserDashboardTourCompany(),
      bottomNavigationBar: const TourCompanyBottomNavigation(),
    );
  }
}
