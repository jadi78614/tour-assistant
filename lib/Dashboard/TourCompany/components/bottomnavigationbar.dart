...
//
// class TourCompanyBottomNavigation extends StatefulWidget {
//   const TourCompanyBottomNavigation({Key? key}) : super(key: key);
//
//   @override
//   State createState() => _TourCompanyBottomNavigationState();
// }
//
// /// This is the private State class that goes with MyStatefulWidget.
// class _TourCompanyBottomNavigationState extends State<TourCompanyBottomNavigation> {
...
import 'package:testing_app/Dashboard/TourCompany/components/touristdashboardbody.dart';
import 'package:testing_app/constants.dart';
...
class TourCompanyBottomNavigation extends StatelessWidget {

  const TourCompanyBottomNavigation({Key? key}) : super(key: key);

  List<Widget> _buildScreens() {
    return [
      UserDashboardTourCompany(),
      SearchTourist(),
      WishlistTourist(),
      BookingTourist(),
      ChatTourist()
