...
class TourCompanyDashboardDrawer extends StatefulWidget {
  String stringid;
  String name;
  String password;
  String address;
  ...
  @override
  State<TourCompanyDashboardDrawer> createState() => _TourCompanyDashboardDrawerState();
}

class _TourCompanyDashboardDrawerState extends State<TourCompanyDashboardDrawer> {
